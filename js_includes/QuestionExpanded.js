...
var __QuestionExpanded_callback__ = null;
var __QuestionExpandeds_answers__ = null;
...
jqueryWidget: {
    _init: function () {
        ...
        if (typeof(this.hasCorrect) == "string") {
            ...
            assert(foundIt, "Value of 'hasCorrect' option not recognized in QuestionExpanded");
        }
        ...
        if (! (this.hasCorrect === false))
            assert(typeof(this.hasCorrect) == "number" && this.hasCorrect < this.answers.length,
                   "Bad index for correct answer in QuestionExpanded");
        ...
        if (this.QuestionExpanded) {
            ...
            .addClass(this.cssPrefix + "QuestionExpanded-text")
            .css('text-align', conf_centerItems ? 'center' : 'left')
            .append(this.QuestionExpanded);
        }
        ...
        __QuestionExpanded_answers__ = new Array(this.answers.length);
        ...
        for (var i = 0; i < this.orderedAnswers.length; ++i) {
            ...
            (function(i) {
                li.click(function () { __QuestionExpanded_callback__(i); });
            })(i);
            ...
            __QuestionExpanded_answers__[i] = ans;
            __QuestionExpanded_callback__ = function (i) {
                var answerTime = new Date().getTime();
                var ans = __QuestionExpanded_answers__[i];
                var correct = "NULL";
                ...
                t.finishedCallback([[[QuestionExpandedField, t.QuestionExpanded ? csv_url_encode(t.QuestionExpanded) : "NULL"],
